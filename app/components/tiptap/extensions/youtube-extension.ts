...
import { getEmbedUrlFromYoutubeUrl, isValidYoutubeUrl, YOUTUBE_REGEX_GLOBAL } from './helpers/utils';
// import YoutubeNode from '../nodes/YoutubeNode.vue';
...
export const Youtube = Node.create<YoutubeOptions>({
  ...
  addAttributes() {
    return {
      ...
      align: {
        default: 'center', // Puede ser 'left', 'right', o 'center'
      },
    }
  },
    ...
    return [
      {
        ...
        src: node.querySelector('iframe')?.getAttribute('src'),
            align: node.getAttribute('data-alignment'),
        }),
      },
    ]
  },
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    const alignment = HTMLAttributes.align || 'center'; // Asegurarse de que siempre tenga un valor válido
    ...
    return [
      'div',
      { 'data-youtube-video': '',
        'data-alignment': HTMLAttributes.align,
