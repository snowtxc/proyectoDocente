    ...
    <div class="w-full flex flex-col gap-2 justify-center border-b border-b-4 border-b-100 p-2">
        ...
        <UCard class="w-2/5 flex flex-col">
          <div class="flex items-center justify-between">
            ...
            <SelectorCompetenciaGeneral  
              ...
              :color="secuencia.espacio?.rgbColor"></SelectorCompetenciaGeneral>
          </div>
          ...
          <div class="flex justify-between gap-2 items-center">
            <div>
              <ul class="list-disc px-2" v-if="secuencia.competencias_especificas.length > 0">
                <li v-for="competenciaEspecifica in secuencia.competencias_especificas" :key="competenciaEspecifica.id"
                  class="my-2">
      ...
      <UCard class="flex-1 flex flex-col">
        <div class="flex items-center justify-between">
          ...
          <InputTextModal
          label="Meta General"
          v-model="secuencia.metaGeneral"></InputTextModal>
        </div>
        <div class="flex justify-between gap-2 items-center">
      ...
      <UCard class="flex-1 flex flex-col mt-2" v-if="secuencia.detallaRecursos">
        <div class="flex items-center justify-between">
          ...
          <InputTextModal
          label="Recursos"
          v-model="secuencia.recursos"></InputTextModal>
        </div>
        <div class="flex justify-between gap-2 items-center">
    ...
    ></BaseSwitch>
      ...
      <UCard class="flex-1 flex flex-col mt-2" v-if="secuencia.detallaMetodologia">
        <div class="flex items-center justify-between">
          ...
          <InputTextModal 
          label="Metodología"
          v-model="secuencia.metodologia"></InputTextModal>
        </div>
        <div class="flex justify-between gap-2 items-center">
